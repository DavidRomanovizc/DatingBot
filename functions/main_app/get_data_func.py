...
async def get_data(telegram_id: int) -> Tuple[str, int, str, str, str,
                                              str, str, str, str, str,
                                              str, str, str, bool,
                                              List[int]]:
    ...
    return (
        ...
        user_voice_comm, user_need_city, is_banned, events
    )


async def get_data_meetings(telegram_id: int) -> Tuple[str, str, str, str, str, str, bool, bool, bool, bool, bool, str]:
